...
route.get('/apps-file-manager', (req, res, next) => {
    res.render('apps-file-manager', { title: 'File Manager', page_title: 'File Manager', folder: 'File Manager' });
})
route.get('/apps-todo', (req, res, next) => {
    res.render('apps-todo', { title: 'Todo', page_title: 'Todo', folder: 'Todo' });
})
