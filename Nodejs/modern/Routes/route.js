...
route.get('/auth-signin-cover', (req, res, next) => {
    res.render('auth-signin-cover', { title: 'Sign In', layout: 'layout/layout-without-nav' });
})
route.get('/auth-signup-basic', (req, res, next) => {
    res.render('auth-signup-basic', { title: 'Sign Up', layout: 'layout/layout-without-nav' });
})
route.get('/auth-signup-cover', (req, res, next) => {
    res.render('auth-signup-cover', { title: 'Sign Up', layout: 'layout/layout-without-nav' });
})
route.get('/auth-pass-reset-basic', (req, res, next) => {
    res.render('auth-pass-reset-basic', { title: 'Reset Password', layout: 'layout/layout-without-nav' });
})
route.get('/auth-pass-reset-cover', (req, res, next) => {
    res.render('auth-pass-reset-cover', { title: 'Reset Password', layout: 'layout/layout-without-nav' });
})
route.get('/auth-pass-change-basic', (req, res, next) => {
    res.render('auth-pass-change-basic', { title: 'Change Password', layout: 'layout/layout-without-nav' });
})
route.get('/auth-pass-change-cover', (req, res, next) => {
    res.render('auth-pass-change-cover', { title: 'Change Password', layout: 'layout/layout-without-nav' });
})
route.get('/auth-offline', (req, res, next) => {
    res.render('auth-offline', { title: 'Offline', layout: 'layout/layout-without-nav' });
})
route.get('/auth-lockscreen-basic', (req, res, next) => {
    res.render('auth-lockscreen-basic', { title: 'Lock Screen', layout: 'layout/layout-without-nav' });
})
route.get('/auth-lockscreen-cover', (req, res, next) => {
    res.render('auth-lockscreen-cover', { title: 'Lock Screen', layout: 'layout/layout-without-nav' });
})
route.get('/auth-logout-basic', (req, res, next) => {
    res.render('auth-logout-basic', { title: 'Logout', layout: 'layout/layout-without-nav' });
})
route.get('/auth-logout-cover', (req, res, next) => {
    res.render('auth-logout-cover', { title: 'Logout', layout: 'layout/layout-without-nav' });
})
route.get('/auth-success-msg-basic', (req, res, next) => {
    res.render('auth-success-msg-basic', { title: 'Success Message', layout: 'layout/layout-without-nav' });
})
route.get('/auth-success-msg-cover', (req, res, next) => {
    res.render('auth-success-msg-cover', { title: 'Success Message', layout: 'layout/layout-without-nav' });
})
route.get('/auth-twostep-basic', (req, res, next) => {
    res.render('auth-twostep-basic', { title: 'Two Step Verification', layout: 'layout/layout-without-nav' });
})
route.get('/auth-twostep-cover', (req, res, next) => {
    res.render('auth-twostep-cover', { title: 'Two Step Verification', layout: 'layout/layout-without-nav' });
})
route.get('/auth-404-basic', (req, res, next) => {
    res.render('auth-404-basic', { title: '404 Error', layout: 'layout/layout-without-nav' });
})
route.get('/auth-404-cover', (req, res, next) => {
    res.render('auth-404-cover', { title: '404 Error', layout: 'layout/layout-without-nav' });
})
route.get('/auth-404-alt', (req, res, next) => {
    res.render('auth-404-alt', { title: '404 Error', layout: 'layout/layout-without-nav' });
})
route.get('/auth-500', (req, res, next) => {
    res.render('auth-500', { title: '500 Error', layout: 'layout/layout-without-nav' });
})
...
route.get('/apps-file-manager', (req, res, next) => {
    res.render('apps-file-manager', { layout: 'layout/layout-without-bradcrumb', title: 'File Manager', page_title: 'File Manager', folder: 'Apps' });
})
route.get('/apps-todo', (req, res, next) => {
    res.render('apps-todo', { layout: 'layout/layout-without-bradcrumb', title: 'Todo', page_title: 'Todo', folder: 'Apps' });
})

// Jobs
route.get('/apps-job-application', (req, res, next) => {
    res.render('apps-job-application', { title: 'Application', page_title: 'Jobs', folder: 'Jobs' });
})
...
route.get('/apps-api-key', (req, res, next) => {
    res.render('apps-api-key', { title: 'API Key', page_title: 'Apps', folder: 'Apps' });
})
...
route.get('/pages-maintenance', (req, res, next) => {
    res.render('pages-maintenance', { layout: 'layout/layout-without-nav', title: 'Maintanance' });
})
route.get('/pages-coming-soon', (req, res, next) => {
    res.render('pages-coming-soon', { title: 'Maintanance', layout: 'layout/layout-without-nav' });
})
...
route.get('/layouts-horizontal', (req, res, next) => {
    res.render('layouts-horizontal', { layout: 'layout/layout-horizontal', title: 'Horizontal', page_title: 'Layouts', folder: 'layouts' });
})
route.get('/layouts-detached', (req, res, next) => {
    res.render('layouts-horizontal', { layout: 'layout/layout-detached', title: 'Detached', page_title: 'Detached', folder: 'layouts' });
})
