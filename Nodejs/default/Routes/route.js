...
route.get('/layouts-horizontal', (req, res, next) => {
    res.render('layouts-horizontal', { layout: 'layout/layout-horizontal', title: 'Horizontal', page_title: 'Horizontal', folder: 'layout' });
})
route.get('/layouts-detached', (req, res, next) => {
    res.render('layouts-detached', { layout: 'layout/layout-detached', title: 'Detached', page_title: 'Detached', folder: 'layout' });
})
route.get('/layouts-two-column', (req, res, next) => {
    res.render('layouts-two-column', { layout: 'layout/layout-twocolumn', title: 'Two Column', page_title: 'Two Column', folder: 'layout' });
})
route.get('/layouts-vertical-hovered', (req, res, next) => {
    res.render('layouts-vertical-hovered', { layout: 'layout/layout-verti-hoverd', title: 'Vertical Hovered', page_title: 'Vertical Hovered', folder: 'layout' });
})
